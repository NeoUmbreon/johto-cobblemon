...
#Route 32
tellraw @a[x=83,y=63,z=-222,dx=11,dy=10,dz=5,tag=!defeated.sageli] ["",{"text":"Have you trained with your Pokémon at Sprout Tower?","color":"white","italic":true}]
execute at @a[x=83,y=63,z=-222,dx=11,dy=10,dz=5,tag=!defeated.sageli] run tp @a[x=83,y=63,z=-222,dx=11,dy=10,dz=5,tag=!defeated.sageli] ~ ~ ~10
...
#Elite Four Gates
#Will
execute if block -1288 67 446 quartz_pillar as @a[x=-1288,y=67,z=446,distance=..15,tag=Will] positioned -1287.5 69.0 446.5 run function johto:sound/playglobalsfx {sfx:"enterdoor",category:"block"}
...
#Koga
execute if block -1288 67 523 quartz_pillar as @a[x=-1288,y=67,z=523,distance=..15,tag=Koga] positioned -1287.5 69.0 523.5 run function johto:sound/playglobalsfx {sfx:"enterdoor",category:"block"}
...
#Bruno
execute if block -1288 70 599 quartz_pillar as @a[x=-1288,y=70,z=599,distance=..15,tag=Bruno] positioned -1287.5 72.0 599.5 run function johto:sound/playglobalsfx {sfx:"enterdoor",category:"block"}
...
#Karen
execute if block -1288 73 675 quartz_pillar as @a[x=-1288,y=73,z=675,distance=..15,tag=Karen] positioned -1287.5 75.0 675.5 run function johto:sound/playglobalsfx {sfx:"enterdoor",category:"block"}
...
#Lance
execute if block -1288 78 750 quartz_pillar as @a[x=-1291,y=77,z=745,dx=6,dy=10,dz=5,tag=Lance] positioned -1287.5 80.5 750.5 run function johto:sound/playglobalsfx {sfx:"enterdoor",category:"block"}
...
#Will
execute if block -1341 67 446 quartz_pillar as @a[x=-1341,y=67,z=446,distance=..15,tag=Will] positioned -1340.5 69.0 446.5 run function johto:sound/playglobalsfx {sfx:"enterdoor",category:"block"}
...
#Koga
execute if block -1341 67 523 quartz_pillar as @a[x=-1341,y=67,z=523,distance=..15,tag=Koga] positioned -1340.5 69.0 523.5 run function johto:sound/playglobalsfx {sfx:"enterdoor",category:"block"}
...
#Bruno
execute if block -1341 70 599 quartz_pillar as @a[x=-1341,y=70,z=599,distance=..15,tag=Bruno] positioned -1340.5 72.0 599.5 run function johto:sound/playglobalsfx {sfx:"enterdoor",category:"block"}
...
#Karen
execute if block -1341 73 675 quartz_pillar as @a[x=-1341,y=67,z=675,distance=..15,tag=Karen] positioned -1340.5 75.0 675.5 run function johto:sound/playglobalsfx {sfx:"enterdoor",category:"block"}
...
#Lance
execute if block -1341 78 750 quartz_pillar as @a[x=-1344,y=77,z=746,dx=6,dy=10,dz=5,tag=Lance] positioned -1340.5 80.5 750.5 run function johto:sound/playglobalsfx {sfx:"enterdoor",category:"block"}
