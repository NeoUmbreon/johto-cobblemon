...
execute if entity @s[x=160,y=0,z=-295,dx=121,dy=49,dz=205] run return run function johto:world/musictitles/small {text:"Ruins of Alph", location:203, includes:""}
execute if entity @s[x=-992,y=59,z=-172,dx=38,dy=20,dz=50] run return run function johto:world/musictitles/small {text:"Ruins of Alph", location:203, includes:""}
...
execute if entity @s[x=495,y=30,z=-275,dx=38,dy=30,dz=21] run return run function johto:world/musictitles/small {text:"Goldenrod Radio Tower", location:206, includes:"unless score @s MusicTitles matches 310 "}
execute if entity @s[x=495,y=30,z=-249,dx=38,dy=30,dz=21] run return run function johto:world/musictitles/small {text:"Goldenrod Radio Tower", location:207, includes:""}
...
#execute if entity @s[x=-2287,y=0,z=-607,dx=271,dy=240,dz=77] run return run function johto:world/musictitles/small {text:"Route 18", location:57, includes:""}

# TODO: Poke Marts & Goldenrod/Celadon Department Stores
...
execute if entity @s[x=-1061,y=0,z=-17,dx=146,dy=240,dz=111] run return run function johto:world/musictitles/small {text:"Mt. Silver", location:104, includes:"unless score @s MusicTitles matches 102..104 "}

# Mt. Silver Cave and Summit
execute if entity @s[x=-1043,y=60,z=102,dx=135,dy=100,dz=270] run return run function johto:world/musictitles/small {text:"Mt. Silver Cave", location:30, includes:"unless score @s MusicTitles matches 30..31 "}
execute if entity @s[x=-967,y=174,z=189,dx=50,dy=30,dz=140] run return run function johto:world/musictitles/small {text:"Mt. Silver Summit", location:31, includes:"unless score @s MusicTitles matches 30..31 "}


#-----------------------------------------------Johto-----------------------------------------------
# Union Cave and Ruins of Alph
execute if entity @s[x=160,y=49,z=-295,dx=121,dy=240,dz=205] run return run function johto:world/musictitles/small {text:"Ruins of Alph", location:87, includes:"unless score @s MusicTitles matches 95 "}
execute if entity @s[x=82,y=0,z=-873,dx=140,dy=60,dz=283] run return run function johto:world/musictitles/small {text:"Union Cave", location:95, includes:"unless score @s MusicTitles matches 87 "}
...
execute if entity @s[x=461,y=0,z=-765,dx=66,dy=240,dz=50] run return run function johto:world/musictitles/small {text:"Route 34", location:72, includes:"unless score @s MusicTitles matches 72..75 "}
...
execute if entity @s[x=639,y=0,z=41,dx=177,dy=240,dz=87] run return run function johto:world/musictitles/small {text:"Route 39", location:77, includes:"unless score @s MusicTitles matches 76..77 "}

# Routes 40-41 and Whirl Islands Exterior
execute if entity @s[x=837,y=0,z=-97,dx=147,dy=240,dz=81] run return run function johto:world/musictitles/small {text:"Route 40", location:78, includes:"unless score @s MusicTitles matches 78..79 unless score @s MusicTitles matches 100 "}
execute if entity @s[x=870,y=0,z=-280,dx=281,dy=240,dz=182] run return run function johto:world/musictitles/small {text:"Route 40", location:78, includes:"unless score @s MusicTitles matches 78..79 unless score @s MusicTitles matches 100 "}
execute if entity @s[x=870,y=0,z=-525,dx=281,dy=240,dz=44] run return run function johto:world/musictitles/small {text:"Route 41", location:79, includes:"unless score @s MusicTitles matches 78..79 unless score @s MusicTitles matches 100 "}
execute if entity @s[x=870,y=0,z=-480,dx=281,dy=240,dz=199] run return run function johto:world/musictitles/small {text:"Whirl Islands", location:100, includes:"unless score @s MusicTitles matches 78..79 unless score @s MusicTitles matches 100 "}
...
# Routes 47-48
execute if entity @s[x=1412,y=0,z=-487,dx=298,dy=256,dz=150] run return run function johto:world/musictitles/small {text:"Route 47", location:85, includes:"unless score @s MusicTitles matches 85..86 "}
execute if entity @s[x=1341,y=0,z=-487,dx=71,dy=256,dz=76] run return run function johto:world/musictitles/small {text:"Route 47", location:85, includes:"unless score @s MusicTitles matches 85..86 "}
...
# Routes 16-22
execute if entity @s[x=-2222,y=0,z=279,dx=272,dy=240,dz=131] run return run function johto:world/musictitles/small {text:"Route 16", location:55, includes:"unless score @s MusicTitles matches 55..61 "}
execute if entity @s[x=-2121,y=0,z=-529,dx=171,dy=240,dz=807] run return run function johto:world/musictitles/small {text:"Route 17", location:56, includes:"unless score @s MusicTitles matches 55..61 "}
execute if entity @s[x=-2287,y=0,z=-607,dx=271,dy=240,dz=77] run return run function johto:world/musictitles/small {text:"Route 18", location:57, includes:"unless score @s MusicTitles matches 55..61 "}
execute if entity @s[x=-2479,y=0,z=-830,dx=225,dy=240,dz=186] run return run function johto:world/musictitles/small {text:"Route 19", location:58, includes:"unless score @s MusicTitles matches 55..61 "}
execute if entity @s[x=-2479,y=60,z=-969,dx=713,dy=180,dz=138] run return run function johto:world/musictitles/small {text:"Route 20", location:59, includes:"unless score @s MusicTitles matches 55..61 "}
execute if entity @s[x=-1765,y=0,z=-824,dx=145,dy=240,dz=419] run return run function johto:world/musictitles/small {text:"Route 21", location:60, includes:"unless score @s MusicTitles matches 55..61 "}
execute if entity @s[x=-1608,y=0,z=-14,dx=263,dy=240,dz=109] run return run function johto:world/musictitles/small {text:"Route 22", location:61, includes:"unless score @s MusicTitles matches 55..61 "}
execute if entity @s[x=148,y=60,z=613,dx=200,dy=30,dz=200] run return run function johto:world/musictitles/small {text:"Route 22", location:61, includes:"unless score @s MusicTitles matches 55..61 "}
...
# Routes 3-10
execute if entity @s[x=-2222,y=0,z=577,dx=436,dy=240,dz=194] run return run function johto:world/musictitles/small {text:"Route 3", location:42, includes:"unless score @s MusicTitles matches 42..49 "}
execute if entity @s[x=-2654,y=0,z=675,dx=403,dy=240,dz=96] run return run function johto:world/musictitles/small {text:"Route 4", location:43, includes:"unless score @s MusicTitles matches 42..49 "}
execute if entity @s[x=-2871,y=0,z=441,dx=211,dy=240,dz=212] run return run function johto:world/musictitles/small {text:"Route 5", location:44, includes:"unless score @s MusicTitles matches 42..49 "}
execute if entity @s[x=-2871,y=0,z=40,dx=252,dy=240,dz=194] run return run function johto:world/musictitles/small {text:"Route 6", location:45, includes:"unless score @s MusicTitles matches 42..49 "}
execute if entity @s[x=-2618,y=0,z=290,dx=118,dy=240,dz=134] run return run function johto:world/musictitles/small {text:"Route 7", location:46, includes:"unless score @s MusicTitles matches 42..49 "}
execute if entity @s[x=-3224,y=0,z=275,dx=352,dy=240,dz=156] run return run function johto:world/musictitles/small {text:"Route 8", location:47, includes:"unless score @s MusicTitles matches 42..49 "}
execute if entity @s[x=-3350,y=60,z=627,dx=513,dy=180,dz=173] run return run function johto:world/musictitles/small {text:"Route 9", location:48, includes:"unless score @s MusicTitles matches 42..49 "}
execute if entity @s[x=-3338,y=60,z=387,dx=116,dy=256,dz=239] run return run function johto:world/musictitles/small {text:"Route 10", location:49, includes:"unless score @s MusicTitles matches 42..49 "}
#---------------------------------------------------------------------------------------------------


# Major Locations (title & subtitle)
execute if entity @s[x=285,y=60,z=-793,dx=125,dy=240,dz=130] run return run function johto:world/musictitles/big {text:"Azalea Town", location:301, color:"dark_green", subtext:"Living Happily with Pokémon", includes:""}
execute if entity @s[x=409,y=63,z=-740,dx=23,dy=7,dz=14] run return run function johto:world/musictitles/big {text:"Azalea Town", location:301, color:"dark_green", subtext:"Living Happily with Pokémon", includes:""}
execute if entity @s[x=-775,y=59,z=125,dx=202,dy=240,dz=206] run return run function johto:world/musictitles/big {text:"Blackthorn City", location:302, color:"dark_gray", subtext:"A Quiet Mountain Retreat", includes:""}
execute if entity @s[x=-2501,y=0,z=236,dx=278,dy=240,dz=199] run return run function johto:world/musictitles/big {text:"Celadon City", location:303, color:"green", subtext:"City of Rainbow Dreams", includes:""}
execute if entity @s[x=-2836,y=0,z=654,dx=181,dy=240,dz=148] run return run function johto:world/musictitles/big {text:"Cerulean City", location:304, color:"dark_aqua", subtext:"The Floral Lagoon City", includes:""}
execute if entity @s[x=-279,y=0,z=-598,dx=217,dy=240,dz=137] run return run function johto:world/musictitles/big {text:"Cherrygrove City", location:305, color:"dark_red", subtext:"The City of Fragrant Flowers", includes:""}
execute if entity @s[x=1152,y=0,z=-525,dx=157,dy=240,dz=244] run return run function johto:world/musictitles/big {text:"Cianwood City", location:306, color:"aqua", subtext:"A Port of Crashing Waves", includes:""}
execute if entity @s[x=-1746,y=63,z=-913,dx=88,dy=20,dz=83] run return run function johto:world/musictitles/big {text:"Cinnabar Island", location:307, color:"dark_red", subtext:"The Ravaged Town of the Past", includes:""}
execute if entity @s[x=236,y=0,z=164,dx=262,dy=100,dz=204] run return run function johto:world/musictitles/big {text:"Ecruteak City", location:308, color:"light_purple", subtext:"A Historical City", includes:""}
execute if entity @s[x=-2513,y=0,z=-642,dx=225,dy=240,dz=187] run return run function johto:world/musictitles/big {text:"Fuchsia City", location:309, color:"light_purple", subtext:"Happening and Passing City", includes:""}
execute if entity @s[x=349,y=0,z=-461,dx=239,dy=240,dz=194] run return run function johto:world/musictitles/big {text:"Goldenrod City", location:310, color:"yellow", subtext:"A Happening Big City", includes:"unless score @s MusicTitles matches 206 "}
...
execute if entity @s[x=-2871,y=0,z=235,dx=252,dy=240,dz=205] run return run function johto:world/musictitles/big {text:"Saffron City", location:318, color:"red", subtext:"Shining Big City", includes:""}
execute if entity @s[x=-2884,y=0,z=-200,dx=273,dy=240,dz=239] run return run function johto:world/musictitles/big {text:"Vermilion City", location:319, color:"red", subtext:"The Port of Exquisite Sunsets", includes:""}
execute if entity @s[x=-42,y=0,z=-161,dx=141,dy=256,dz=261] run return run function johto:world/musictitles/big {text:"Violet City", location:320, color:"dark_purple", subtext:"The City of Nostalgic Scents", includes:""}
execute if entity @s[x=100,y=0,z=-90,dx=90,dy=256,dz=190] run return run function johto:world/musictitles/big {text:"Violet City", location:320, color:"dark_purple", subtext:"The City of Nostalgic Scents", includes:""}
execute if entity @s[x=-1800,y=0,z=-44,dx=191,dy=240,dz=166] run return run function johto:world/musictitles/big {text:"Viridian City", location:321, color:"aqua", subtext:"The City of Evergreen", includes:""}


# Other Locations (actionbar)
execute if entity @s[x=876,y=60,z=52,dx=54,dy=10,dz=76] run return run function johto:world/musictitles/small {text:"Reception Desk", location:3, includes:""}
...
execute if entity @s[x=-1366,y=63,z=676,dx=110,dy=240,dz=74] run return run function johto:world/musictitles/small {text:"Elite Four", location:14, includes:"unless score @s MusicTitles matches 311 "}
execute if entity @s[x=-1366,y=63,z=372,dx=110,dy=240,dz=302] run return run function johto:world/musictitles/small {text:"Elite Four", location:14, includes:"unless score @s MusicTitles matches 311 "}
#execute if entity @s[x=1169,y=252,z=619,distance=..40] run return run function johto:world/musictitles/small {text:"Fly Map", location:15, includes:"unless score @s MusicTitles matches 0.. "}
...
execute if entity @s[x=530,y=0,z=-793,dx=170,dy=240,dz=228] run return run function johto:world/musictitles/small {text:"Ilex Forest", location:21, includes:""}
execute if entity @s[x=-972,y=64,z=-410,dx=11,dy=11,dz=11] run return run function johto:world/musictitles/small {text:"Lobby", location:24, includes:""}
...
execute if entity @s[x=-2447,y=40,z=832,dx=144,dy=40,dz=77] run return run function johto:world/musictitles/small {text:"Mt. Moon Square", location:26, includes:"unless score @s MusicTitles matches 26..27 "}
...
execute if entity @s[x=-1776,y=0,z=123,dx=252,dy=240,dz=429] run return run function johto:world/musictitles/small {text:"Route 2", location:41, includes:""}
...
execute if entity @s[x=1309,y=0,z=-411,dx=52,dy=240,dz=60] run return run function johto:world/musictitles/small {text:"Cliff Edge Gate", location:101, includes:""}
