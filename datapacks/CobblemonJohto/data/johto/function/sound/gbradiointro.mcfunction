...
#-----------------------------------------------Johto-----------------------------------------------
# New Bark Town
execute if score @s MusicTitles matches 314 run return run function johto:sound/playrecord {track:"gb/settlements/newbarktownintro", duration:12}

# Elm's Lab
execute if score @s MusicTitles matches 201 run return run function johto:sound/playrecord {track:"gb/areas/elmpokemonlabintro", duration:127}
...
execute if score @s MusicTitles matches 203 run return run function johto:sound/playrecord {track:"gb/areas/ruinsofalphintro", duration:29}
...
execute if score @s MusicTitles matches 213 run return run function johto:sound/playrecord {track:"gb/areas/gamecornerintro", duration:19}

# National Park
execute if score @s MusicTitles matches 32 run return run function johto:sound/playrecord {track:"gb/areas/nationalparkintro", duration:6}

# Ecruteak City (& Cianwood City)
# Loop Only

# Ecruteak Dance Theater
execute if score @s MusicTitles matches 211 run return run function johto:sound/playrecord {track:"gb/areas/ecruteakdancetheaterintro", duration:5}

# Burned Tower
execute if score @s MusicTitles matches 215 run return run function johto:sound/playrecord {track:"gb/areas/burnedtowerintro", duration:169}

# Routes 38-39
execute if score @s MusicTitles matches 76..77 run return run function johto:sound/playrecord {track:"gb/routes/38intro", duration:73}
...
# Routes 47-48
execute if score @s MusicTitles matches 85..86 run return run function johto:sound/playrecord {track:"gb/routes/47intro", duration:24}

# Safari Zone Gate
execute if score @s MusicTitles matches 89 run return run function johto:sound/playrecord {track:"gb/areas/safarizonegateintro", duration:70}
...
#-----------------------------------------------Kanto-----------------------------------------------
# Routes 26-27
execute if score @s MusicTitles matches 64..65 run return run function johto:sound/playrecord {track:"gb/routes/26intro", duration:95}

# S.S. Aqua
execute if score @s MusicTitles matches 94 run return run function johto:sound/playrecord {track:"gb/areas/ssaquaintro", duration:121}

# Vermilion City
execute if score @s MusicTitles matches 319 run return run function johto:sound/playrecord {track:"gb/settlements/vermilioncityintro", duration:89}

# Lavender Town
execute if score @s MusicTitles matches 312 run return run function johto:sound/playrecord {track:"gb/settlements/lavendertownintro", duration:161}
