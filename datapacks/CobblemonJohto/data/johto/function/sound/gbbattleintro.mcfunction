# Timings and logic for retro battle music intros
...
execute if score @s BattleStart matches 20 run return run function johto:sound/playrecord {track:"gb/battle/raikouenteisuicuneintro", duration:254}
