...
execute as @s[x=-856,y=65,z=720,distance=..6,tag=!Clair] at @s run runmolangscript johto:dialogue_check_battle @s @n[type=cobblemon:npc,distance=..16,nbt={Config:{trainer_id:clair}}]
